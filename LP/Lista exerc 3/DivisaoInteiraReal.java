/*
 6 - Crie um arquivo chamado DivisaoInteiraReal.java. 
 * Complete o código, substituindo a seqüência xxxxx com 
 * operações de divisão, 
 * operações de casting e 
 * parênteses. O programa deve exibir os
números 2, 2.5, 2.5, 2.5 e 2.0 nessa ordem. 
* A cada linha complete o código de uma forma diferente.
